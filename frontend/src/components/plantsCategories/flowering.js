...
const ApiUrl = 'http://localhost:8000/api/plants/floweringPlants'
        ...
        <>
          <div className="bg-white">
            <div className="mx-auto max-w-2xl px-4 py-1 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
              <h2 className="text-2xl font-bold tracking-tight text-green-900"> Flowering Plants</h2>
      ...
      />
                    ...
                    <div className="mt-4 flex justify-between">
                      <div>
                        ...
                        <h3 className='h3 text-green-900'>Rs {plant.price}</h3>
