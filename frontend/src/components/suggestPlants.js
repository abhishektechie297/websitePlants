...
export default function SuggestPlant() {
  ...
  const ApiUrl = "http://localhost:8000/api/myplant/suggestPlant";

  const handleButtonClick = async () => {
    try {
      // Include user's answers in the API request body
  ...
  return (
    <div className="container-fluid">
      <div>
        <h1 className="heading">Suggest me a plant</h1>
      </div>
      <div className="div2">
        ...
        <div className="d-grid gap-2 col-6 mx-auto">
          <button className="btn btn-primary btn1" type="button" onClick={handleButtonClick}>Find this type of plant...</button>
        </div>
